...
public class JDateChooser extends JPanel implements ActionListener,
	...
	public JDateChooser(JCalendar jcal, Date date, String dateFormatString,
		...
		calendarButton = new JButton(new ImageIcon(JDateChooser.class.getResource("/Image/icons8_calendar_40px_3.png"))) {
		...
		calendarButton.setBackground(new Color(33, 44, 61));
